...
- [tokenslim](https://github.com/devilking7x/tokenslim) — Client-side workbench for cutting LLM token spend: rule-based prompt compressor with real BPE counts, 350-skill router demo, model cascade planner, thinking-budget slider, semantic cache, and budget planner with savings dashboard. No backend. [Live demo](https://devilking7x.github.io/tokenslim/)
