...
- [contextdiet](https://github.com/devilking7x/contextdiet) — Local-first context-window analyzer for AI coding agents. Drop in CLAUDE.md, skill files, or `.mcp.json` for real BPE token counts (gpt-tokenizer), a per-file breakdown ranked by size, a %-of-window gauge with the 20% rule, impact-ordered trim suggestions, and a before/after savings simulator. Live demo: https://devilking7x.github.io/contextdiet/.
